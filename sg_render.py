...
#######################################################################################################
def render_with_sg(lgtSGs, specular_reflectance, roughness, diffuse_albedo, normal, viewdirs, diffuse_rgb=None):
    '''
    :param lgtSGs: [M, 7]
    ...
    brdfSGLambdas = (2. * inv_roughness_pow4).unsqueeze(-2).unsqueeze(-2).expand(dots_shape + [M, K, 1])
